...
def login():
    ...
    # ✅ Access token (short-lived)Add commentMore actions
    access_token = create_access_token(
        identity=email,
        additional_claims={"role": user["role"]},
        expires_delta=timedelta(minutes=15)  # You can adjust this if neededAdd commentMore actions
    )
     # ✅ Refresh token (long-lived)Add commentMore actions
